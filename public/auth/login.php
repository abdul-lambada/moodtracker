...
if (\App\Auth\AuthManager::check()) {
    $user = \App\Auth\AuthManager::user();
...
$redirect = session_get('__auth_redirect', '../admin/index.php');
...
<head>
    ...
    <title>Masuk Admin | MoodTracker</title>
...
<body class="bg-mood-soft text-mood-ink min-h-screen flex items-center justify-center">
    <div class="w-full max-w-lg px-6 py-10 bg-mood-surface border border-mood-border rounded-3xl shadow-xl page-enter">
        <div class="text-center space-y-2 page-enter-delay">
            ...
            <h1 class="text-3xl font-bold text-mood-ink">Masuk Dashboard</h1>
            <p class="text-sm text-mood-muted">Gunakan kredensial karyawan untuk mengakses dashboard admin.</p>
        </div>
        ...
        <form action="login_process.php" method="POST" class="mt-8 space-y-5 page-enter-delay-lg">
            <?php echo csrf_field(); ?>
